...
# 1: Create a county list and county votes dictionary.county_names = []
county_names = []
county_votes = {}
...
with open(file_to_save, "w") as txt_file:
    ...
    # 6a: Write a for loop to get the county from the county dictionary. for county in county_votes:
    for county in county_votes:        # retreive vote count and percentage
